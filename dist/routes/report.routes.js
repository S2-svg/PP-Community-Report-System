...
router.get("/user/:userId", auth_middleware_1.authenticate, (0, error_middleware_1.asyncHandler)(controller.findByUser));
router.get("/users/:userId", auth_middleware_1.authenticate, (0, error_middleware_1.asyncHandler)(controller.findByUser));
router.get("/category/:categoryId", auth_middleware_1.authenticate, (0, error_middleware_1.asyncHandler)(controller.findByCategory));
...
router.get("/status/:status", auth_middleware_1.authenticate, (0, error_middleware_1.asyncHandler)(controller.findByStatus));
